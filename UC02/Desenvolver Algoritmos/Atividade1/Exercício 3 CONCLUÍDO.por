...
necessárias, observando o limite citado acima.*/
	...
	inteiro numeroCadeirasAlfa = 220, numeroConvidados,numeroCadeirasBeta = 350,cadeirasExtras, cadeirasExtrasFixasAlfa = 70
	...
	}se((numeroConvidados > 0 ) e (numeroConvidados < 221)){
		cadeirasExtras = numeroCadeirasAlfa - numeroConvidados + (-70)
		escreva("No seu caso o auditório Alfa seria ideal com: ", cadeirasExtras," cadeiras extras e: ", numeroCadeirasAlfa  - numeroConvidados - cadeirasExtras  , " adicionais")
		}se((numeroConvidados > 220 ) e (numeroConvidados < 351)){
			escreva("No seu caso o auditório Beta seria o ideal,porém lamento informar que não é possível acrescentar mais cadeiras :("," \nMas ainda estão disponíveis: ",numeroCadeirasBeta - numeroConvidados," cadeiras")
			}
